...
set_property PACKAGE_PIN M5 [get_ports {pci_exp_rxp[0]}]
...
set_property PACKAGE_PIN P5 [get_ports {pci_exp_rxp[1]}]
...
set_property PACKAGE_PIN R3 [get_ports {pci_exp_rxp[2]}]
...
set_property PACKAGE_PIN T5 [get_ports {pci_exp_rxp[3]}]
